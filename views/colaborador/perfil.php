...
function encuentraColaborador2($rutColaborador) {
...
function encuentraAmigos2($rutColaborador) {
...
function encuentraComentarios($idPost) {
    ...
    $query->select([
            ...
            ->from('colaborador')
            ->join('INNER JOIN', 'comentarios', 'comentarios.rut =colaborador.rutColaborador')
...
<script>
    ...
    function enviar(post, rut) {
        ...
        if (dato == true && valid == 2) {
            ...
            $.get("../post/comentario?rutPersona=" + rut + "&idPost=" + post + "&comentario=" + comentario + "",
                    function (dato) {
                        var data = JSON.parse(dato);
                        $('#' + post).html('<a class="pull-left" href="#"><img style="-ms-transform: rotate(' + data.rotate + 'deg);-webkit-transform: rotate(' + data.rotate + 'deg);transform: rotate(' + data.rotate + 'deg);" class="avatar perfill" alt="Avatar" src="/frontend/web/img/perfil/t/' + data.foto + '"></a><div class="comment-body"><div class="comment-heading"><h4 class="comment-user-name"><a href="#">' + data.nombre + ' ' + data.apellidos + '</a></h4><h5 class="time">Ahora</h5></div><p style="text-transform: initial;">' + comentario + '</p></div>');
                        $("#comentario-" + post + "").val('');
    ...
    function like(idPost, rut) {
        ...
        $.get("../post/like?rutPersona=" + rut + "&idPost=" + idPost + "",
                function (dato) {
                            ...
                            <div class="widget panel-friends">
                                ...
                                <div class="widget-body bordered-top bordered-red text-center">
                                    ...
                                    <ul class="friends">
                                        ...
                                        $model2 = encuentraAmigos2($model->rutColaborador);

                                        foreach ($model2 as $amigo) {
                                            $modell3 = encuentraColaborador2($amigo["rut2"]);
                                            ?>
                                            ...
                                            <li>
                                                ...
                                                <a href="compadre?rutAmigo=<?php echo $modell3[0]['rutColaborador'] ?>">
                                                    ...
                                                    <img style="-ms-transform: rotate(<?php echo $modell3[0]['rotador']; ?>deg);
                                                         ...
                                                         transform: rotate(<?php echo $modell3[0]['rotador']; ?>deg);" src="../img/perfil/t/<?php echo $modell3[0]['foto']; ?>" title="<?php echo $modell3[0]['nombreColaborador'] . " " . $modell3[0]['apellidosColaborador']; ?>" class="img-responsive tip">
                                        ...
                                        <div class="media-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-10 col-xs-7">
                                                    ...
                                                    <textarea onKeyDown="contarCaracteres(this.form.descripcionPost, this.form.remLen, 180);" placeholder="Que estas pensando hoy??? " maxlength="180"  name="rdescripcionPost" data-ls-module="charCounter" placeholder="Que estas pensando hoy??? " rows="5" maxlength="180" class="form-control input-lg p-text-area"></textarea>
                            ...
                            <div class="tab-pane fade in active" id="activities">
                                ...
                                <script>
                                    ...
                                    function mycontent(mypage) {
                                        ...
                                        $('#ani_img').show();
                                        $.get('reload?page=' + mypage + '&rutColaborador=<?php echo $rutColaborador; ?>', function (data) {
